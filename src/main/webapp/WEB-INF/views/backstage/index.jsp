        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li>
                        <a href="#subTables" data-toggle="collapse" class="collapsed"><i class="lnr lnr-dice"></i> <span>Tables</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                        <div id="subTables" class="collapse ">
                            <ul class="nav">
                                <li><a href="page-profile.html" class="">User</a></li>
                                <li><a href="page-login.html" class="">Manager</a></li>
                                <li><a href="page-lockscreen.html" class="">Product</a></li>
                            </ul>
                        </div>
                    </li>
