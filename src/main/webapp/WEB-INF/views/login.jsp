        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div>
                    ...
                    <a href="<c:url value='/user/toRegiste.do'/>" class="primary-btn">CREATE AN ACCOUNT</a>
                </div>
            </div>

            <div class="col-md-5" style="margin-left: 120px">
                ...
                <div>
                    ...
                    <a href="javascript:login();" class="primary-btn" style="margin-left: 2px">LOGIN</a>
