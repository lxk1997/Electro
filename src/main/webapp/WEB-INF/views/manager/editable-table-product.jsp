    ...
    window.onload = function () {
        ...
        var db = {
            ...
            updateItem: function (updatingClient) {
                $.ajax({
                    type: 'post',
                    url: '<c:url value="/product/updateProduct.do?type=editable"/> ',
                    data: {
                        pid: updatingClient["Product Id"],
                        pname: updatingClient["Product Name"],
                        cid: updatingClient["Category Id"],
                        price: updatingClient["Price"],
                        firsocost: updatingClient["Firstcost"],
                        discount: updatingClient["Discount"],
                        stock: updatingClient["Stock"]
                    }
                })
            },
            ...
            deleteItem: function (deletingClient) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<c:url value="/product/deleteProduct.do?type=editable"/> ',
                    data: {
                        pid: deletingClient["Product Id"]
                    },
                    dataType: 'text',
                    success: function (data) {
                        if(data == "SUCCESS") {
        ...
        $("#jsGrid").jsGrid({
            ...
            fields: [
                ...
                {name: "Category Id", type: "text", width: 50},
                {name: "Price", type: "text"},
                {name: "Firstcost", type: "text"},
